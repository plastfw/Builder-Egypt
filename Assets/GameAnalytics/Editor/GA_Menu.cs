...
namespace GameAnalyticsSDK.Editor
{
    public static class GA_Menu
    {
        ...
        static void AddGASystemTracker ()
        {
            ...
            {
                UnityEngine.GameObject go = PrefabUtility.InstantiatePrefab(AssetDatabase.LoadAssetAtPath(GameAnalytics.WhereIs("GameAnalytics.prefab", "Prefab"), typeof(UnityEngine.GameObject))) as UnityEngine.GameObject;
